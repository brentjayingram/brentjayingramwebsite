...
#
#   terraform import aws_s3_bucket.kb_documents <KB_DOCUMENTS_BUCKET>
...
# The data source is managed manually in the AWS console.
# ---------------------------------------------------------------------------
...
resource "aws_bedrockagent_knowledge_base" "resume_kb" {
  ...
  role_arn    = "arn:aws:iam::${var.aws_account_id}:role/service-role/AmazonBedrockExecutionRoleForKnowledgeBaseBrunnyAws"
  ...
  storage_configuration {
    ...
    opensearch_serverless_configuration {
      collection_arn    = "arn:aws:aoss:us-east-1:${var.aws_account_id}:collection/placeholder"
